...
# символов должен дойти целиком, когда модель извлекает из него правила), а выход раундов со
# второго шире выбора: модель может писать в аргументе данные — например, JSON правил.
TOOL_FLOW_MAX_ROUNDS = 6
TOOL_FLOW_MAX_STEPS = 10
TOOL_FLOW_CONTEXT_CHARS = 24000
TOOL_FLOW_MAX_WORDS = 1000
