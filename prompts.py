"""Жёстко зашитые системный и агентный промпты Tabletop AI Assistant."""
...
AGENT_PROMPT = """Твоя задача — обрабатывать только запросы, связанные с настольными играми.
...
def build_system_message() -> str:
    """Объединяет системный и агентный промпты в единое системное сообщение для API."""
